...
- [src/qprompt.langium](src/qprompt.langium) -  The grammar definition of your language
- [src/qprompt-module.ts](src/qprompt-module.ts) - The dependency injection module of your language implementation. Use this to register overridden and added services.
- [src/qprompt-validator.ts](src/qprompt-validator.ts) - An example validator. You should change it to reflect the semantics of your language.
...
- [src/syntaxes/qprompt.monarch.ts](src/syntaxes/qprompt.monarch.ts) - Monarch based syntax highlighting instructions.
- [syntaxes/qprompt.tmLanguage.json](syntaxes/qprompt.tmLanguage.json) - Textmate based syntax highlighting instructions.
